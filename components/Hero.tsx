        ...
        <Reveal>
          ...
          <div className="flex items-center gap-4 mt-8">
            ...
            <span className="text-[13.5px] text-white/55 font-medium">
              <strong className="text-white/85">{h.socialProofStrong}</strong>{" "}
              {h.socialProofText}
            </span>
          </div>
        </Reveal>
        ...
        <Reveal className="relative">
          <div className="relative bg-gradient-to-br from-green-1 to-green-3 rounded-[20px] border border-white/10 p-5 shadow-hero overflow-hidden">
            ...
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <div className="hidden sm:block text-xs text-white/40 font-semibold">
                07.07.2026 · 10:24
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2.5 mb-3.5">
              <div className="rounded-[11px] p-3.5 flex flex-col gap-2.5 bg-red">
                ...
                <div className="text-[11px] sm:text-xs font-bold text-white/90">
                  {h.panel.cards[0]}
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-[1.2fr_1fr] gap-2.5">
              <div className="bg-white rounded-[11px] p-3.5">
                ...
                <div className="text-lg font-extrabold text-ink tracking-tight">
                  24,850,000
                </div>
              ...
              <div className="bg-white rounded-[11px] p-3.5">
                <div className="text-[11px] font-bold text-muted uppercase tracking-wide mb-2.5">
                  {h.panel.cashboxStatus}
                </div>
                <div className="text-lg font-extrabold text-teal-700 tracking-tight">
                  142,300,000
                </div>
                <div className="text-[11px] text-muted font-medium mt-0.5">
                  {h.panel.cashboxSub}
          ...
          <div className="hidden sm:flex absolute -bottom-5 -left-6 items-center gap-2.5 bg-white rounded-xl shadow-[0_8px_28px_rgba(0,0,0,.18)] px-4 py-3">
            ...
            <div>
              <div className="text-base font-extrabold text-ink leading-none">
                {h.panel.realtimeLabel1}
              </div>
              <div className="text-[11px] text-muted font-medium mt-0.5">
                {h.panel.realtimeLabel2}
              </div>
            </div>
          </div>
        </Reveal>
