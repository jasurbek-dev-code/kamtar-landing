    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Kamatar ERP — Biznesingizni raqamlashtiring",
      },
    ],
  },
  twitter: {
...
const jsonLd = {
  ...
  name: "Kamatar ERP",
  alternateName: ["Каматар ЕРП", "Kamatar ЕРП дастури"],
